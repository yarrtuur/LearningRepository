...
public class TableViewTest {
	...
	private TableView command;

	@BeforeClass
    public static void setUpClass() {
		System.out.println("Before TableViewTest.class");
	}

	@AfterClass
    public static void tearDownClass() {
		System.out.println("After TableViewTest.class");
	}

	@Before
    public void setUp() {
		singleCommand = "tables";
		command = new TableView(dbManagerMock, viewMock);
	}
